        ...
        await createUserWithEmailAndPassword(auth, email, password)
            ...
            .catch((error) => {
                if (
                    ...
                    toast("Email already in use, Please login instead.", {
                        type: "error",
                        position: "top-right",
                        autoClose: 3000,
                        closeOnClick: true,
        ...
        <>
            ...
            <main className={styles.signup_page}>
                ...
                <section className={styles.signup_form}>
                    ...
                    <div className={styles.signUpWithEmailCont}>
                        <div className={styles.divider}></div>
                        <span className={styles.signupwithemail}>
